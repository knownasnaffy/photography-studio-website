...
export function TermsOfServicePage() {
  return (
    <>
      <Seo
        title="Terms of Service | Lucky Photography"
        description="Read the terms and conditions for using the Lucky Photography website and submitting service inquiries."
