          ...
          <FadeIn delay={0.2}>
            <form className="space-y-8 bg-surface-container/30 p-8 md:p-12 border thin-border">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col">
                  ...
                  <input 
                    type="text" 
                    id="firstName" 
                    className="bg-transparent border-b thin-border py-2 text-on-surface font-body-md transition-colors"
                  />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <select 
                  id="inquiryType" 
                  className="bg-transparent border-b thin-border py-2 text-on-surface font-body-md transition-colors focus:outline-none focus:border-b-primary"
                >
              ...
              <div className="flex flex-col">
                ...
                <textarea 
                  id="message" 
                  rows={4}
                  className="bg-transparent border-b thin-border py-2 text-on-surface font-body-md transition-colors resize-none"
